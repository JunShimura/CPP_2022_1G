...
int main()
{
	...
	if (i < _countof(kuronekoSize)) {
		cout << "クロネコでの箱のサイズは" << kuronekoSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(yupackSize)) {
		cout << "ゆうパックでの箱のサイズは" << yupackSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(kuronekoSize)) {
		cout << "クロネコでの円柱のサイズは" << kuronekoSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(yupackSize)) {
		cout << "ゆうパックでの円柱のサイズは" << yupackSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(kuronekoSize)) {
		cout << "クロネコでの円錐のサイズは" << kuronekoSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(yupackSize)) {
		cout << "ゆうパックでの円錐のサイズは" << yupackSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(kuronekoSize)) {
		cout << "クロネコでの球のサイズは" << kuronekoSize[i] << "サイズです" << endl;
	}
	else {
	...
	if (i < _countof(yupackSize)) {
		cout << "ゆうパックでの球のサイズは" << yupackSize[i] << "サイズです" << endl;
	}
	else {
